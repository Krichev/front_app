// ====================== MediaPlaybackPhase.tsx ======================
// Unchanged except small clean-ups & comments. Already passes enableFullscreen/initialFullscreen=true
// (Assumes your ExternalVideoPlayer forwards these props to YouTubePlayer)
    ...
    return (
        ...
        >
            <Text style={styles.title}>
                {mediaType === 'VIDEO'
                    ? t('wwwPhases.mediaPlayback.watchVideo')
                    : t('wwwPhases.mediaPlayback.listenAudio')}
            </Text>
            ...
            {playbackEnded && (
                <View style={{marginTop: 24, gap: 12}}>
                    ...
                    <TouchableOpacity style={styles.continueButton} onPress={onPlaybackComplete}>
            ...
            {!playbackEnded && (
                <TouchableOpacity style={styles.skipButton} onPress={onSkip}>
                    <Text style={styles.skipButtonText}>
                        {t('wwwPhases.mediaPlayback.skipMedia')}
                    </Text>
                </TouchableOpacity>
            )}
        </ScrollView>
...
export default MediaPlaybackPhase;