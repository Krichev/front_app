 ...
 */
export const createModalStyles = (theme: Theme, screenHeight: number) =>
  StyleSheet.create({
    // ============================================
    // OVERLAY & BACKDROP
    // ============================================
...
/**
 * Creates static styles for non-themed usage (fallback)
 */
export const createFallbackStyles = (screenHeight: number) =>
  StyleSheet.create({
    overlay: {
      position: 'absolute',
      top: 0,
 ...
 */
export const styles = createFallbackStyles(800); // Default fallback