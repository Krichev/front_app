...
const ru = {
    ...
    rhythmChallenge: {
        ...
        startTapping: 'Начать отстукивание',
        startRecording: 'Начать запись',
        playingPattern: 'Воспроизведение ритма...',
        getReady: 'Приготовьтесь!',
        loadingChallenge: 'Загрузка вызова...',
        questionNotFound: 'Вопрос не найден',
        processing: 'Обработка...',
        tapMode: 'Режим касания',
        clapMode: 'Режим хлопков',
        patternInfo: '{{beats}} ударов • ~{{bpm}} BPM • {{timeSignature}}',
        stopRecording: 'Стоп',
        listenAgain: 'Послушать еще раз',
        replaysLeft: 'Осталось повторов: {{count}}',
        replaysLeft_one: 'Остался {{count}} повтор',
        replaysLeft_few: 'Осталось {{count}} повтора',
        replaysLeft_many: 'Осталось {{count}} повторов',
        replaysLeft_other: 'Осталось {{count}} повторов',
        unlimitedReplays: 'Повторы не ограничены',
        noReplaysLeft: 'Повторов не осталось',
        tapAlong: 'Настукивайте в такт ритму!',
        recording: 'Запись...',
        notEnoughTaps: 'Недостаточно нажатий',
        notEnoughTapsMessage: 'Пожалуйста, нажмите хотя бы 2 раза для отправки.',
        retry: 'Попробовать снова',
        continue: 'Продолжить',
        done: 'Готово',
        tapsProgress: 'Нажатий: {{current}} / {{total}}',
        modeSelector: {
            title: 'Выберите способ ввода',
            tap: 'Нажатие',
            audio: 'Звук',
        },
        results: {
        ...
        errors: {
            ...
            microphonePermission: 'Для записи аудио необходимо разрешение на использование микрофона',
            recordingTooShort: 'Запись слишком короткая. Пожалуйста, запишите хотя бы 1 секунду.',
            recordingFailed: 'Не удалось сохранить запись. Попробуйте ещё раз.',
            fileTooLarge: 'Файл записи слишком большой. Попробуйте более короткую запись.',
            invalidAudio: 'Формат аудио не распознан. Попробуйте ещё раз.',
            networkError: 'Ошибка сети. Проверьте подключение и попробуйте снова.',
            scoringFailed: 'Не удалось проанализировать ваш ритм. Попробуйте ещё раз.',
            retryFailed: 'Всё ещё не удаётся подключиться. Попробуйте позже.',
        },
    },
    challenge: {
    ...
    challengeDetails: {
        ...
        launcher: {
            ...
            failedToStart: 'Не удалось создать сессию викторины. Попробуйте ещё раз.',
            error: 'Ошибка',
        },
        status: {
            active: 'Активный',
        ...
        verification: {
            photo: 'Фотоверификация',
            location: 'Проверка местоположения',
            quiz: 'Викторина',
            manual: 'Ручная проверка',
    ...
    audioGamePlay: {
        ...
        processing: 'Оценка вашего исполнения...',
        ...
        rhythmReady: 'Готовы? Начинайте, когда будете готовы!',
        rhythmListenFirst: 'Прослушайте ритм, затем повторите его',
        soundMatchInstructions: 'Повторите звуки как можно точнее',
        singingInstructions: 'Спойте вместе с треком',
        notEnoughTaps: 'Недостаточно нажатий',
        minTapsRequired: 'Пожалуйста, нажмите хотя бы несколько раз для оценки.',
    },
    puzzle: {
        setup: {
            title: 'Создать пазл',
